"""
Django settings for aged_breeze_41096 project.
...
ROOT_URLCONF = 'aged_breeze_41096.urls'
...
WSGI_APPLICATION = 'aged_breeze_41096.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_breeze_41096 API",
    "DESCRIPTION": "API documentation for aged_breeze_41096 App",
    "VERSION": "v1",
}
